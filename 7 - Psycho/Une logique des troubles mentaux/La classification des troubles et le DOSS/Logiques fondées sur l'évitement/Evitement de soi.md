...
- Evitement au moindre lien (physique/Psychique) avec la situation redoutée 
	- -> Fuite / focalisation sur des sensations internes. 
		- Peur de la peur -> emballement exponentiel. 
			- Sujet refermé sur lui même -> résonnance du sentiment sujet de la tentative d'évitement. 
		- Possible symptômes physique: suffocation, emballement cardiaque
	- Attaque de panique. 
- Souvent: les sujet engagés dans ce type de processus s'arriment à d'autres.
	- Acceptent de leur venir en aide 
		- Alimente un équilibre dysfonctionnel.

- <u>Troubles ou signes cliniques concernés</u>:
	- Attaques de panique 
- <u>Techniques utilisées</u>:
	- **Recadrages**
		- Valoriser l'affrontement de la peur "La peur que l'on évite se transforme en panique, la peur que l'on affronte se transforme en courage"
		- Demande d'aide = meilleur moyen d'aggraver le problème : "Chaque fois que la personne accepte, elle vous envoie deux messages: un message d'amour mais aussi un second, implicite, qui vous confirme votre incapacité à gérer seul."
			- Remplacer une peur par une plus grande 
			- Si impossible d'y renoncer, songer à ce double message à chaque nouvelle demande qui aggrave le problème.
	- **Tâches**
		- Pour le porteur de symptômes:
			- *Imaginer le pire* & affronter l'émotion ressentie. 
				- Objectif: diminuer progressivement l'intensité émotionnelle et assouplir le réflexe d'évitement spontané 
			- *Carnet de bord*
				- Empêcher le rétrécissement du champ perceptif. 
		- Pour les aidants:
			- A partir des explications du phénomène fournies au patient, iels sont invité.es à permettre au porteur de symptôme de redevenir autonome en le laissant affronter ses peurs. 
				- En modifiant leur stratégie:
					- Limiter leur aide, la rendre moins fiable. 
			- Si l'aidant est un proche ayant ce rôle depuis longtemps, prévenir d'un possible déplacement de symptôme.
				- Privé de son rôle, l'aidant peut vivre une réorganisation profonde de sa vie. 
					- A envisager avec la personne. 

### Renoncer à se battre, abandonner, se résigner: la dépression. 
...
- Souvent: lamentations, partage social de leur misère - Largement compréhensible car continuelle - 
	- Comportement ne faisant qu'amplifier le mal être.
- Tendance à se poser en victime 
	- Déléguer la solution de leur problème à d'autres voire l'exiger.
		- "Vous ne vous rendez pas compte de mon malheur !", "Il faut que vous m'aidiez !"
	- Les proches vont écouter/réconforter/stimuler/encourager la personne déprimée à faire des choses dont elle est pourtant incapable.
		- Th. : bloquer ces tentatives.
			- Si les proches acceptent ces consignes, c'est que le patient fini par les épuiser tous et sont donc également demandeur d'une aide pour gérer la situation autrement. 
- TH. : soutenir le patient en se montrant ferme à son égard.
	- Eviter que les entretiens n'alimentent sa tentative de solution dysfonctionnelle. 
	- L'inciter à mettre en oeuvre les tâches prescrites.
...
- <u>Techniques utilisées</u>:
	- **Recadrages**
		- Si absence de force/volonté, la poursuite d'objectifs = génère des déceptions à répétition. 
			- Recadrer la recherche d'objectif comme moyen d'aggraver le sentiment d'échec
				- "On voit l'avenir avec les yeux du présent"
		- On préférera : utiliser la frustration comme moteur d'un changement 
			- "C'est trop tôt", "Surtout, arrêtez de vous forcer à quoique ce soit, il faut d'abord récupérer des forces"
			- En la justifiant via la "convalescence du sportif blessé"
		- Balzac : "*La résignation est un suicide quotidien*"
	- **Tâches** 
		- Pour le porteur de symptômes 
			- *Conspiration du silence* 
			- Si besoin : *Chaire de vérité*
			- *Comment aggraver ?*
				- Permet à certains patients de découvrir eux même les conduites qui renforcent leur dépression : éviter les contacts sociaux, en parler sans cesse avec certaines personnes de leur entourage, ruminer tous leurs déboires et leurs échecs. 
			- Pour ceux qui s'efforcent - dans la souffrance - de se mettre en action (parfois poussés par leur entourage):
				- TH. encourage au repos nécessaire pour recouvrer des forces.
					- En utilisant ce que la personne est encore capable de faire : regarder n'importe quelle série voire s'abrutir devant la télévision (patients souvent incapables de lire)
						- Leur permettre de faire ce qu'ils essaient de ne pas faire ou que les autres leur reprochent de faire.
			- Dès que la situation le permet:
				- *Comme si* : induire de nouvelles interactions. 
		- Pour les aidants:
			- Expliquer le mécanisme de dépression en termes interactionnels, rassurer sur l'utilité de continuer à aider une personne déprimée, mais d'une aide efficace pour éviter d'essayer de combler un puits sans font : <u>ne pas</u> rassurer, encourager, proposer des solutions. 
			- S'ils sont découragés/Excédés par les plaintes continuelles:
				- Les rendre plus actifs dans le traitement en leur suggérant de priver stratégiquement le patient des activités qu'ils recommandent actuellement, **de façon à stimuler sa frustration**, donc sa colère, comme motivation : "*Je t'aurais bien proposé de venir au cinéma avec moi mais comme tu ne vas pas bien, je ne te le propose pas. Il vaut mieux que tu te reposes à la maison*". 

### Remarque concernant les formes de dépression 

- Résignation : survient à l'issue de divers parcours. 
	- Pour permettre un travail plus adapté : questions pour déterminer son mode de construction. 

- Constructions progressives. 
	- Peuvent remonter à l'adolescence, voire avant ("Je suis déprimé depuis toujours")
	- Souvent en lien avec une situation familiale (parent dépressif ou très anxieux, parents excessivement contrôlants)
	- Dans ces cas là:
		- Utilisation de la connotation négative de la demande d'aide (aggrave le problème).
			- Amener le patient à ne plus faire systématiquement appel au réseau qu'il a construit durant toutes ces années.
				- Implique les proches mais également des professionnels : médecins, service d'urgence/ d'accompagnement de personnes en difficultés. 

- Suite à un événement spécifique, souvent vécu très douloureusement.
	- Dépression amoureuse, conflit dévastateur, perte douloureuse d'un proche, d'un emploi. 
	- Il y a un avant / après. 
		- Comparaison de malheurs actuels à cet avant. 
		- Th. Doit identifier si le patient attribue son effondrement à lui-même ou à d'autres. 
			- A lui même:
				- Techniques utilisés dans les situation de stress post trauma : *Roman du trauma*, rebaptisé ici en *"La contemplation du désastre"* 
				- Avant de recourir aux techniques propres aux dépressions. 
			- A autrui:
				- D'abord effectuer un travail sur la colère/frustration : *Lettres de colère* adressées aux personnes présumées responsables de la dépression.
		- Dans le cas où les patients se sont remis de leur déception passée mais n'arrivent pas à se remettre en action : *Comment aggraver ?* 

- Suite à une succession d'évitements liés  à des troubles anxieux de plus en plus envahissants.
	- Technique de traitement de l'anxiété: *Imaginer le pire* 
	- En parallèle de celles utilisées pour traiter la dépression.

- Construite sur une base de contrôle.
	- Forme d'épuisement provenant des tentatives de contrôle dysfonctionnelles, multiples efforts infructueux. 
	- Si personne surtout déçue d'elle même car sentiment de retomber sans cesse dans les mêmes pièges -> tendance à s'encourager, se mettre au défit, se forcer.
		- Mais incapable de s'y mettre car "le coeur n'y est pas".
			- Multiplie les échecs -> confirme sa déception. 
			- Th : doit enrayer ce processus. 
				- Bloquer les ruminations
					- *Technique du bûcheron*
					- Recadrages pour l'empêcher de poursuivre dans cette voie: 
						- *"Chaque fois que vous testez votre motivation, vous aggrabez votre problème. Vous êtes comme ce sportif de haut niveau qui a été blessé et qui, avant d'être rétabli, cherche à évaluer s'il pourra reproduire ses performances antérieures. Plus vous le faites, plus vous aggravez votre état."*
