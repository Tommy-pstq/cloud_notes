...
- Porteurs des gênes associés au TSA mais pas de TSA déclaré -> meilleure score aux tests que le groupe de contrôle.
Seconde étude sur 1522 individus:
*  risque polygenique pour le TSA -> score plus élevés aux tests de QI
